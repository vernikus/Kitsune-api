...
<template>
  <nav class="navbar  bg-light" v-if="!user.loadingSesion">
    <div class="container d-flex justify-content-end gap-4">
      ...
      <router-link class="btn btn-primary" to="/list" v-if="user.data" >Check List</router-link>
      <router-link class="btn btn-primary" to="/list-edit" v-if="user.data">Edit List</router-link>
